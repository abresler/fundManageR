...
* `get_data_adv_managers_periods_summaries`-- Retrieves summary ADV filings for specified periods and filing type.  You must specify a directory and a folder name.  The default folder name is set to adv_data and if no directory is specified the data will be downloaded into your working directory.
...
* [ADV Function Tutorial -- Sleuthing The Blackstone Group](http://rstudio-pubs-static.s3.amazonaws.com/211957_2ab9d98c70ac4fdc9c1672f0924177b0.html)
