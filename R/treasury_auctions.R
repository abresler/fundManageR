    ...
    tibble(
      ...
      nameActual =
        c(
          ...
          "amount_discount_rate_high",
          "amount_investment_rate_high",
          "amount_price_high",
          "amount_discount_margin_high",
          "pct_yield_high",
          "ratio_index_on_issue_date",
          "amount_indirect_bidder_accepted",
          "amount_indirect_bidder_tendered",
          "type_interest_payment_frequency",
          "amount_discount_rate_low",
          "amount_investment_rate_low",
          "amount_price_low",
          "amount_discount_margin_low",
          "pct_yield",
          "date_maturing",
