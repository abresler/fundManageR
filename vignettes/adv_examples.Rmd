...
One fantastic feature of the [pdftools](https://github.com/ropensci/pdftools) package is it's metadata extraction capabilities, a feature `fundManageR` utilizes.  When a PDF file is processed we unearth a host of fields describing who, what, when, where and how a PDF file was created.  One powerful field that may be given to us is a PDF author field.  It is safe to say if we find the person who created CT INVESTMENT MANAGEMENT's filed brochure and their name appears in the metadata of a brochure we know to be a Blackstone related entity that CT is related to Blackstone. 
...
It looks like `buergerm` *has* authored some of the PDFs that we KNOW are related to Blackstone which is pretty conclusive evidence that CT INVESTMENT MANAGEMENT is a Blackstone related manager.
