...
packages <- 
  c('fundManageR', 'dplyr', 'flexdashboard', 'rbokeh', 'tidyr', 'purrr', 'stringr', 'shiny', 'tibble', 'd3treeR', 'treemap', 'taucharts')
...
```{r inputs}
textInput("assetName", "Asset Name", "500 Park Avenue", width = '150px')
# purchase price
